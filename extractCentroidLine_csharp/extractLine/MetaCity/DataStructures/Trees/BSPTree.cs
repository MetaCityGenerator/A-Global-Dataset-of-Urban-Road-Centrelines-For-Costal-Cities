...
{
    public sealed class BSPTreeNode : ITreeNode<double>, IComparable<BSPTreeNode>
    {
    ...
    public sealed class BSPTree : IBinarySearchTree<double>
    {
        ...
        private static void FindFamilies(BSPTreeNode parent, BSPTreeNode left, BSPTreeNode right)
        {
            left.Parent = parent;
            right.Parent = parent;
        ...
        private static BSPTreeNode[][] CoulpeItems(BSPTreeNode[] input)
        {
            int size = 2;
        ...
        private int GetTreeHeight(BSPTreeNode node)
        {
            if (node == null)
                return 0;
